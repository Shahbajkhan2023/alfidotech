...
title = Label(root, text="TryCatch-Password Generator", fg="Blue", font=("Arial", 15, 'bold')).place(x=200, y=10)
...
s1.place(x=550, y=40)
scale_lable = Label(root, text="Length", font=("Arial", 11)).place(x=500, y=40)

strength_lable = Label(root, text="Password Strength", font=("Arial", 12, "bold")).place(x=280, y=80)
...
btn = Button(master=root, text="calculate", fg="green", font=("Arial", 10, 'bold'), command=generate_pass).place(x=300, y=150)

password_entry = Entry(root, width=30)
password_entry.place(x=220, y=200)

copy_btn = Button(master=root, text="Copy", fg="green",font=("Arial", 10, 'bold'), command=copyclip).place(x=320, y=230)
